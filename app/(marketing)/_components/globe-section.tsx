  ...
  return (
    <section>
      <motion.div
        ...
        className="div"
      >
        <h2 className="text-3xl font-extrabold tracking-tight sm:text-4xl md:text-5xl lg:text-6xl text-center">
          <Balancer>
            Jotion is use{" "}
        ...
        <p className="pt-4 text-center leading-normal text-muted-foreground sm:text-xl sm:leading-8">
          <Balancer>
      ...
      <div className="w-full h-96 z-10">
